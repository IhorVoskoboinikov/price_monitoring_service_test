...
def create_price_history_partition_task() -> str:
    ...
    logger.info(f"[TASK] create_price_history_partition_task finished | partition={result}")
    return result
...
async def _create_partition_async() -> str:
    ...
    with log_operation(logger, "create_price_history_partition", partition=partition_name):
